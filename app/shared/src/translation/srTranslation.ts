...
export const srTranslation: TranslationKeys = {
    ...
    ClientMessageCreateWatcherDone: `Dogovoreno. Čim nađemo povoljniju cenu poslaćemo Vam e-poruku.`,
    ...
    ClientTitle: `Pratite bolju cenu od {?}?`,
    ClientDestinationsReturn: `od{_}{?} do{_}{?} i{_}nazad`,
    ClientDestinationsOneway: `od{_}{?} do{_}{?}`,
    ClientDescription: `Pratimo za Vas! I svaki dan ćete dobijati novosti.`,
